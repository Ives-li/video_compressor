...
class GrayData(Dataset):
    def __init__(self, data_root, cr, frame_height, frame_width, *args, **kwargs):
    ...
    def process_all_data(self):
        ...
        total_pics = len(all_pics)
        remainder = total_pics % self.cr
        if remainder != 0:
            excess = remainder
            all_pics = all_pics[:-excess]
        ...
        self.frames_per_measurement = pics.shape[2] // self.cr
